<template>
    ...
    <ul
        class="container d-flex flex-wrap align-content-start justify-content-center align-items-stretch"
        :class="[...classObj.containerClass, { iconOff }]">
        <li class="px-1 py-3 rounded-3 overflow-hidden">
            ...
            <strong :class="['subtitle', ...classObj.subtitleClass]">
                다양한 환경
            </strong>
            <p :class="['dec m-0', ...classObj.decClass]">
                환경에 영향을 받지 않고 동일한 정보를 전달하도록 개발합니다.
            </p>
        </li>
        <li class="px-1 py-3 rounded-3 overflow-hidden">
            <span :class="[...classObj.iconClass]">
            ...
            <p :class="['dec m-0', ...classObj.decClass]">
                사용자가 사이트에 집중할 수 있도록 속도 개선에 대해 끊임 없이 고민하며 불필요한 인터렉션을 최소화 하기 위해 노력합니다.
            </p>
        </li>
        <li class="px-1 py-3 rounded-3 overflow-hidden">
            <span :class="[...classObj.iconClass]">
            ...
            <p :class="['dec m-0', ...classObj.decClass]">
                사용자의 행동 경로와 A/B 테스트 등의 통계를 기반으로 개발하여 이탈률을 감소시킵니다.
            </p>
        </li>
    </ul>
</template>
